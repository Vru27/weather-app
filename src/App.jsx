...
function App() {
  ...
  return (
    <>
      <div className="w-screen select-none min-h-screen  bg-linear-to-br from-blue-50 via-purple-50 to-orange-50 dark:from-blue-950 dark:via-purple-950 dark:to-orange-950 flex items-center justify-center p-4">
